...
class Curl
{
    ...
    public function curlInit()
    {
        ...
        curl_setopt($this->curlHander, CURLOPT_SSL_VERIFYHOST, 2);                      // 从证书中检查SSL加密算法是否存在
        ...
        curl_setopt($this->curlHander, CURLOPT_TIMEOUT, 120);                            // 设置超时限制防止死循环
        ...
        curl_setopt($this->curlHander, CURLOPT_HTTPHEADER, array (
            'X-FORWARDED-FOR:' . $ip,
            'CLIENT-IP:' . $ip,
            'Expect:',
